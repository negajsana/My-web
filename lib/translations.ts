export const translations = {
  uk: {
    ...
    portfolioPage: {
      title: "Портфоліо",
      subtitle: "Кейси, які приносять вимірювані бізнес-результати.",
      trustStatement: "6 міжнародних кейсів у юридичній, освітній, аерокосмічній та преміум-нішах.",
      ctaTitle: "Хочете подібний результат для вашого бізнесу?",
      ctaButton: "Отримати безкоштовний стратегічний дзвінок",
  ...
  ru: {
    ...
    projects: {
      ...
      luerssen: {
        title: "Lürssen",
        description: "Корпоративный сайт международной судостроительной компании премиум-сегмента. Реализована адаптивная вёрстка, оптимизация скорости загрузки, структурирование контента и улучшение UI/UX.",
        result: "+220% трафика",
      },
      isarAerospace: {
        title: "Isar Aerospace",
        description: "Корпоративный сайт аэрокосмической компании. Реализован современный технологичный интерфейс, адаптивная вёрстка, оптимизация производительности.",
        result: "$500M+ инвестиций",
      },
      providentLaw: {
        title: "Provident Law LLP",
        description: "Сайт юридической компании. Реализована удобная структура услуг, формы обратной связи, SEO-оптимизация и адаптивный дизайн.",
        result: "5000+ клиентов",
      },
      rcnb: {
        title: "Real Club Náutico de Barcelona (RCNB)",
        description: "Официальный сайт яхт-клуба международного уровня. Выполнена адаптивная вёрстка, структурирование информации о событиях и регатах.",
        result: "+140% бронирований",
      },
    },
    portfolioPage: {
      title: "Портфолио",
      subtitle: "Кейсы, которые приносят измеримые бизнес-результаты.",
      trustStatement: "6 международных кейсов в юридической, образовательной, аэрокосмической и премиум-нишах.",
      ctaTitle: "Хотите похожий результат для вашего бизнеса?",
      ctaButton: "Получить бесплатный стратегический звонок",
    ...
    caseStudyPage: {
      ...
      duration: "Длительность сотрудничества",
      primaryCtaTitle: "Хотите похожий результат для вашего бизнеса?",
      primaryCtaButton: "Получить бесплатный стратегический звонок",
  ...
  en: {
    ...
    projects: {
      ...
      luerssen: {
        title: "Lürssen",
        description: "Corporate website for an international premium shipbuilding company. Delivered responsive layout, performance optimization, structured content, and improved UI/UX.",
        result: "+220% traffic",
      },
      isarAerospace: {
        title: "Isar Aerospace",
        description: "Corporate website for an aerospace company. Implemented a modern tech-focused interface, responsive layout, performance optimisation, and structured presentation.",
      ...
      rcnb: {
        title: "Real Club Náutico de Barcelona (RCNB)",
        description: "Official website of an international yacht club. Delivered responsive layout, structured presentation of events and regattas, optimized content and improved navigation.",
        result: "+140% bookings",
      },
    },
    portfolioPage: {
      title: "Portfolio",
      subtitle: "Case studies that deliver measurable business growth.",
      trustStatement: "6 international case studies across legal, education, aerospace, and premium sectors.",
      ctaTitle: "Want similar results for your business?",
      ctaButton: "Get a Free Strategy Call",
    ...
    caseStudyPage: {
      ...
      results: "Results",
      trustLine: "These results were achieved during real client collaboration.",
      duration: "Duration of cooperation",
      primaryCtaTitle: "Want similar results for your business?",
      primaryCtaButton: "Get a Free Strategy Call",
      visitProject: "Visit Project Website",
    },
    contact: {
